...
var MethodDataType = /** @class */ (function (_super) {
    ...
    MethodDataType.prototype.strictDecode = function (calldata, rules) {
        var value = _super.prototype.decode.call(this, calldata, __assign({}, rules, { isStrictMode: true }), this._methodSelector);
    ...
    MethodDataType.prototype.strictDecodeReturnValue = function (returndata, rules) {
        var returnValues = this._returnDataType.decode(returndata, __assign({}, rules, { isStrictMode: true }));
